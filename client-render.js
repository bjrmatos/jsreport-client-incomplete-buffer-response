...
/**
 * ================= INTENTO SIN PROMESAS =============
 * // intentao sin promesas, solo usar setTimeout o process.nextTick
 */
//  reportClient.render({
//    template: {
//      shortid: 'VkNparuL',
...
//  }, function(err, reportResponse) {
//   if (err) {
//     return console.error('error in pdf generation:', err);
//   }

//   // only pausing and later resuming will make the setTimeout and process.nextTick work correctly..
//   reportResponse.pause();

//   // NO DATA (NO CALLBACK CALLED) WHEN USING setTimetout(.., 0 o 100)
//   // LOST DATA WHEN USING process.nextTick
//   setTimeout(function() {
//     console.log('Por obtener buffer..');

//     reportResponse.body(function(reportBody) {
//       var pdfSize = reportBody;
